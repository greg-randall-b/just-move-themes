...
<div class="wrapper" id="full-width-page-wrapper" style="padding: 0; height: 80vh; overflow: hidden;">

	
<video autoplay muted loop id="newVideo">
  <source src="/wp-content/themes/zone/img/NL2.mp4" type="video/mp4">
</video>
    ...
    <div class="<?php echo esc_html( $container ); ?>">
        <div class="row">
            <div class="col-md-2" data-aos="fade-up" id="feed1">
                ...
                <a href="https://www.facebook.com/JustMoveNorthLakeland" target="_blank"><img src="/wp-content/themes/zone/img/large-facebook.png" alt="Follow us on Facebook" /></a>
            </div>
    ...
    <div class="<?php echo esc_html( $container ); ?>">
        <div class="row">
		    <div class="col-lg-6" id="classes" data-aos="fade-up">
		        <h2 style="color: #fff;">Today’s Group Classes</h2>
