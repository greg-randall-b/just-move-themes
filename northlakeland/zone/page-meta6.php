<?php
/**
 * Template Name: Meta 6 - Fitness Industry Leader
 *
...
<div id="formwrap" class="aboutwrap">
	...
	<div class="<?php echo esc_html( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row" data-aos="fade-up" id="amen">
			<div class="col-lg-3">
				<p>Weight Machines</p>
				<img src="/wp-content/themes/zone/img/weightmach1.jpg" />
				
			</div>

			<div class="col-lg-3">
				<p>Large Group Training</p>
				<img src="/wp-content/themes/zone/img/largegroup1.jpg" />
				
			</div>

			<div class="col-lg-3">
				<p>Small Group Training</p>
				<img src="/wp-content/themes/zone/img/smallgroup2.jpg" />
				
			</div>

			<div class="col-lg-3">
				<p>Athletic Training</p>
				<img src="/wp-content/themes/zone/img/athletic3.jpg" />
		...
		<div class="row"  data-aos="fade-up" id="amen">
			<div class="col-lg-3 offset-sm-1">
				...
				<img src="/wp-content/themes/zone/img/functional1.jpg" />
				
			</div>

			<div class="col-lg-3">
				<p>Strength Training</p>
				<img src="/wp-content/themes/zone/img/strength1.jpg" />
				
			</div>

			<div class="col-lg-3">
				<p>CrossFit</p>
				<img src="/wp-content/themes/zone/img/crossfit1.jpg" />
