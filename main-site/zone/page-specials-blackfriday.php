<?php
/**
 * Template Name: Specials BLACK FRIDAY
 *
...
<div style="background: url('<?php the_post_thumbnail_url( 'large' ); ?>'); background-size: cover; background-repeat: no-repeat;" id="intwrap">
	...
	<div class="container" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<?php if( get_the_ID() == '9853') { ?>
			<?php include_once('countdown.php'); ?>
			<img src="/wp-content/uploads/2021/11/skip2.png" alt="Skip the Lines: Join for $1 and 3 months free" id="skip" />
			<?php } ?>
		...
		<div class="row">
			...
			<div class="col-md-8 offset-md-2 content-area" id="primary">
				...
				<main class="site-main" id="main" role="main">
					...
					<h2 style="padding-top: 0;">BLACK FRIDAY SALE</h2>
...
<div class="homebutton"><a href="http://www.justmovenorthlakeland.com/appointment" style="font-size: 16px">BOOK APPOINTMENT</a></div>
...
<div class="homebutton"><a href="http://www.justmovesouthlakeland.com/appointment" style="font-size: 16px">BOOK APPOINTMENT</a></div>
...
<div class="homebutton"><a href="http://www.justmovewinterhaven.com/appointment" style="font-size: 16px">BOOK APPOINTMENT</a></div>
...
<div class="homebutton"><a href="http://www.justmovehavendale.com/appointment" style="font-size: 16px">BOOK APPOINTMENT</a></div>
