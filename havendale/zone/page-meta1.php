<?php
/**
 * Template Name: Meta 1 - Local Gym
 *
...
<div id="formwrap" class="aboutwrap">
	...
	<div class="<?php echo esc_html( $container ); ?>" id="content" tabindex="-1">
		...
		<div class="row">
			...
			<div class="col-sm-4 offset-sm-1 lefty" data-aos="fade-up" id="blubox">
				<img src="/wp-content/themes/zone/img/awesome.png" alt="high five" />
				<?php the_field('left_column'); ?>
				
			</div>

			<div class="col-sm-4 offset-sm-2 righty" data-aos="fade-up" id="blubox">
								<img src="/wp-content/themes/zone/img/meh.png" alt="meh" />
